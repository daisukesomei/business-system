    ...
    <table class="table table-zebra w-full border border-gray-300">
        ...
        <tbody>
            <tr>
                ...
                <td class="text-center border-t border-gray-300"><a href="{{ route('customers.show' ,$salesproject->customer_id)}}" class="text-blue-600/100 underline">{{ $salesproject->customer->customername }}</a></td>
